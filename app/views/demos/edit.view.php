<?php require __DIR__.'/../admin/partials/head.php'; ?>
  ...
  <div class="app-dashboard-body-content off-canvas-content" data-off-canvas-content>
    ...
    <div class="grid-x align-justify">
      <a href="/admin-demos"><i class="fas fa-long-arrow-alt-left"></i> Demos</a>
      <button data-open="deleteDemo" class="button small alert margin-bottom-0">
        <i class="fas fa-trash"></i>
        Delete demo
      </button>
    </div>

    <div class="reveal" id="deleteDemo" data-reveal>
      <p>The demo will be permanently deleted.</p>
      <form class="padding-vertical-1 text-center" action="/demos/<?= $demo->id; ?>" method="POST">
    ...
    <h2 class="text-center">Edit «&thinsp;<?= $demo->title; ?>&thinsp;»</h2>
    <hr>
    ...
    <div class="grid-x margin-top-2 align-center">
      ...
      <?php require __DIR__ . '/../partials/errors.php'; ?>
        ...
        <?php if($demo->image) : ?>
          <div class="grid-x">
            <div class="small-4">
              <p class="margin-bottom-0">Cover image (<?= $demo->image; ?>)</p>
              <figure>
          ...
          <div class="reveal" id="deleteImage" data-reveal>
            ...
            <form class="padding-vertical-1 text-center" action="/demos/<?= $demo->id; ?>/image" method="POST">
        ...
        <form action="/demos/<?= $demo->id; ?>" method="POST" enctype="multipart/form-data"
          ...
          <label>Title
            <input name="title" type="text" placeholder="Title of the post" value="<?= $demo->title; ?>" required pattern="^.{3,50}$">
            <span class="form-error">
              Name is required and must contain between 3 and 50 characters.
            </span>
          </label>
